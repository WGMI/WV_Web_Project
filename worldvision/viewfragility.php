              ...
              <div class="box box-warning" style="width: 100%">
				...
				<section class="content-header">
			        ...
			        <section class="content-button">
			        	<div class="pull-left">
								<a href="addfragility.php" type="button" class="btn btn-warning btn-block btn-flat"><i class="fa fa-plus"></i> Add Fragility Index</a>
							</div>
			        </section>
			        <br>
			        <hr>
        ...
        <tbody>
        	<?php
				...
				while ($row = mysqli_fetch_assoc($fragility_query)) {
					...
					<a class='btn btn-sm btn-warning' href='update_fragility.php?editfragility={$id}'><i class='fa fa-pencil-square-o' aria-hidden='true'></i></a>
                              <a class='btn btn-sm btn-danger delete_fragility'  data-fragility-id=".$row['fragility_index_id']." href='javascript:void(0)'><i class='fa fa-trash-o' aria-hidden='true'></i></td>";
					echo "</tr>";
